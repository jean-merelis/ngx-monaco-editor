...
import {EditorInitializedEvent, NgxMonacoEditorComponent, StandaloneCodeEditor} from "../src/lib/ngx-monaco-editor.component";
import {DefaultMonacoLoader, MonacoAPI, NGX_MONACO_LOADER_PROVIDER} from "../src/lib/monaco-loader";
